...
import '/index.dart';
import 'settingsnav_model.dart';

export 'settingsnav_model.dart';

class SettingsnavWidget extends StatefulWidget {
  const SettingsnavWidget({super.key});

  @override
  State<SettingsnavWidget> createState() => _SettingsnavWidgetState();
}

class _SettingsnavWidgetState extends State<SettingsnavWidget> {
  late SettingsnavModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingsnavModel());
