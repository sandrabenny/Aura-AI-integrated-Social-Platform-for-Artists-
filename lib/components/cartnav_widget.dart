...
import '/index.dart';
import 'cartnav_model.dart';

export 'cartnav_model.dart';

class CartnavWidget extends StatefulWidget {
  const CartnavWidget({super.key});

  @override
  State<CartnavWidget> createState() => _CartnavWidgetState();
}

class _CartnavWidgetState extends State<CartnavWidget> {
  late CartnavModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartnavModel());
